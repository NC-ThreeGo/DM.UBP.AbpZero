...
using DM.UBP.Domain.Service.SysManage.Storage;
...
namespace DM.UBP.Domain.Service.SysManage.MultiTenancy.Demo
{
    /// <summary>
    ...
    /// </summary>
    public class TenantDemoDataBuilder : UbpDomainServiceBase, ITransientDependency
    {
