...
using DM.UBP.Application.Service.SysManage.Authorization;
...
using DM.UBP.Domain.Service.SysManage.Authorization.Impersonation;
...
using DM.UBP.Domain.Service.SysManage.Web;
        ...
        public virtual async Task<ActionResult> Register(RegisterViewModel model)
        {
            try
            {
                ...
                if (model.IsExternalLogin)
                {
                    ...
                    model.Password = DM.UBP.Domain.Entity.SysManage.Authorization.User.CreateRandomPassword();
